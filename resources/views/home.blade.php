...
<body class="bg-gray-900 min-h-screen text-white">
    ...
    <div class="bg-gray-800 py-4 flex justify-between">
        <a href="{{ url('/') }}" class="pl-4 bg-gray-800">
            <img src="{{ asset('tes.png') }}" alt="Logo" class=" h-6 sm:h-8 w-auto">
        </a>
        @if (Auth::check())
                    ...
                    <div class="text-white flex flex-col">
                        <div class="flex mb-2">
                            ...
                            <div class="sm:ml-10 text-xs sm:text-base">
                                ...
                                <button type="button" onclick="changeValue('name')"><img src="{{asset('edit.svg')}}"/></button>
                            </div>
                        </div>
                        <div class="flex mb-2">
                        ...
                        <div class="flex mb-2">
                            ...
                            <div class="sm:ml-10 text-xs sm:text-base">
                                ...
                                <button type="button" onclick="changeValue('age')"><img src="{{asset('edit.svg')}}"/></button>
                            </div>
                        </div>
                        <div class="flex mb-2">
                            ...
                            <div class="sm:ml-10 text-xs sm:text-base">
                                ...
                                <button type="button" onclick="changeValue('address')"><img src="{{asset('edit.svg')}}"/></button>
                            </div>
                        </div>
                        <div class="flex mb-2">
                            ...
                            <div class="sm:ml-10 text-xs sm:text-base">
                                ...
                                <button type="button" onclick="changeValue('phone')"><img src="{{asset('edit.svg')}}"/></button>
                            </div>
                        </div>
                        <div class="flex mb-2">
